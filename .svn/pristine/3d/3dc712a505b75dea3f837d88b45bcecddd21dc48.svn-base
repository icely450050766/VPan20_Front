...
angular.module('VPan20_Front')
  ...
  .controller('tradeBuildController', function($scope, $ionicHistory, $stateParams, $timeout, testService, $ionicPopup, $q,sdk_factory, $state) {
      var wxUtil=new(sdk_factory.carry());
      //alert(wxUtil.getOpenID());
    $scope.my = { product: '',
      type: '',
      direction:'',
      count:'',//手数
    ...
    $scope.goBack = function(){
      //$ionicHistory.goBack();
      $state.go('tab.trade',{}, {reload: false});
    }
