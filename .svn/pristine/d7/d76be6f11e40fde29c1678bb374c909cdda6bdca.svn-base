  ...
  .factory('sdk_factory',['$rootScope',function($rootScope){
    ...
    var WxUtil = function(){
      ...
      _config.authLoginUrl = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + _config.appId + '&redirect_uri='
        +_config.h5serverUrl+'/wxauth/login&response_type=code&scope=snsapi_userinfo&state=gh#wechat_redirect';
      ...
      //赢取领家眷分享页面
      this.winnerStamp=function(){
        wx.onMenuShareAppMessage({
          title: '送你10元买一手 超低成本学投资！', // 分享标题
          desc:'多种产品只需10元一手，收益随时提现，快来和我一起玩爱赚微盘吧',//分享描述
          link: _config.h5serverUrl + '/index.html?fromBackend=true#/tab/receiveWinTicket',// 分享链接
          imgUrl: _config.h5serverUrl + '/img/focu.png', // 分享图标
          success: function () {
          },
          cancel: function () {
            // 用户取消分享后执行的回调函数
